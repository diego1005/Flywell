...
<body>
    ...
    <section>
        <div class="cape">
            ...
            <!--<button type="button" name="eoform" id="eoform" onclick="capaOrder('eoform')">Editar</button>-->
            <!--<button type="button" name="doform" id="doform" onclick="capaOrder('doform')">Eliminar</button>-->
        </div>
